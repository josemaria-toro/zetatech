...
public sealed class ErrorsController : ControllerBase
{
    ...
    public ErrorsController(IPublisher publisher)
    {
    ...
    public async Task<IActionResult> PublishAsync()
    {
        ...
        try
        {
            var trackingObject = Request.ReadAsJson<Error>();
